...
type
  ...
  /// <summary> Parent class for callback methods. A client callback needs to override the
  /// </summary>
  ...
  public
    ...
    /// <summary> see <see cref="com.borland.dbx.json.DBXCallback.execute(Object)"/>
    /// </summary>
  ...
  public
    ...
    /// <summary> Converts 0..16 to the equivalent hex digit
    ///  
    /// </summary>
    /// <param name="digit">0 to 16 number</param>
  ...
  protected
    ...
    /// <seealso cref="com.borland.dbx.json.JSONAncestor.addDescendant(com.borland.dbx.json.JSONAncestor)"/>
    procedure AddDescendant(const Descendant: TJSONAncestor); override;
  ...
  public
    ...
    /// <seealso cref="com.borland.dbx.json.JSONString.estimatedByteSize()"/>
    function EstimatedByteSize: Integer; override;
  ...
  protected
    ...
    ///  
    /// </summary>
    /// <param name="Descendent">- JSON pair</param>
    procedure AddDescendant(const Descendant: TJSONAncestor); override;
  private
    ...
    /// <param name="Pos">current offset</param>
    /// <param name="count">buffer capacity</param>
    ...
    ///  
    /// </summary>
    /// <param name="JSONByteReader">raw byte data</param>
    /// <param name="Parent">parent JSON entity</param>
    /// <returns>next offset</returns>
    ...
    /// <param name="Data">raw byte data</param>
    /// <param name="Pos">current offset</param>
    /// <param name="count">buffer last count</param>
    /// <param name="Parent">parent JSON entity</param>
    /// <returns>next offset</returns>
  ...
  public
    ...
    /// <seealso cref="com.borland.dbx.json.JSONAncestor.toBytes(byte[],"/>
